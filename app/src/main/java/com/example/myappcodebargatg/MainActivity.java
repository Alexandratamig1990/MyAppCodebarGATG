package com.example.myappcodebargatg;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void extractBarCodeQRCodeInfo(List<Barcode> barcodes) {
        for (Barcode barcode : barcodes) {
            ...
            Log.d(TAG, "estracBarCode: rawValue:" + rawValue);
            ...
            switch (valueType) {
                case Barcode.TYPE_WIFI: {
                    ...
                    String encryption = "" + typeWifi.getEncryptionType();

                    Log.d(TAG, "extractBarCodeQRCodeInfo:TYPE_WIFI:" + ssid);
                    Log.d(TAG, "extractBarCodeQRCodeInfo:ssid:" + ssid);
                    Log.d(TAG, "extractBarCodeQRCodeInfo:password:" + password);
                    Log.d(TAG, "extractBarCodeQRCodeInfo:encryptionType:" + encryption);
                ...
                case Barcode.TYPE_URL: {
                    ...
                    Log.d(TAG, "estractBarCodeQRCodeInfo: TYPE_URL");
                    Log.d(TAG, "estractBarCodeQRCodeInfo: title:" + title);
                    Log.d(TAG, "estractBarCodeQRCodeInfo: url" + url);
                ...
                case Barcode.TYPE_EMAIL: {
                    ...
                    Log.d(TAG, "extractBarCodeQRCodeInfo:boby" + boby);
                ...
                case Barcode.TYPE_CONTACT_INFO: {
                    ...
                    String titile = "" + typeContact.getTitle();
                    ...
                    Log.d(TAG, "estractBarCodeQRCodeInfo:TYPE_CONTACT_INFO");
                    Log.d(TAG, "estractBarCodeQRCodeInfo:title:" + titile);
                    Log.d(TAG, "estractBarCodeQRCodeInfo:organizer" + organizer);
                    Log.d(TAG, "estractBarCodeQRCodeInfo:name" + name);
                    Log.d(TAG, "estractBarCodeQRCodeInfo:phone" + phone);
    ...
    private void pickImageGallery() {
        ...
        galleryActivityResulLaucher.launch(intent);
    }

    private final ActivityResultLauncher<Intent> galleryActivityResulLaucher = registerForActivityResult(
        ...
        switch (requestCode) {
            case CAMERA_REQUEST_CODE: {
                if (grantResults.length > 0) {
                    ...
                    boolean strorageAccepted = grantResults[1] == PackageManager.PERMISSION_GRANTED;
                    if (cameraAccepted && strorageAccepted) {
                        pickImageCamera();
                    } else {
            ...
            case STORAGE_REQUEST_CODE: {
                if (grantResults.length > 0) {
                    boolean strorageAccepted = grantResults[0] == PackageManager.PERMISSION_GRANTED;
                    if (strorageAccepted) {
                        pickImageGallery();
                    } else {
